...
<img src="http://omnimasudo.com/wp-content/uploads/2017/08/blossom-bunny-corner-e1502812175733-300x189.jpg" width="300">
<img src="http://omnimasudo.com/wp-content/uploads/2017/08/blossom-jellyfish-768x606.jpg" width="300" >

**For any questions (assembly or software related), [please check/make public issues](https://github.com/omnimasudo/blossom-public/issues).**

## Get repo
In a terminal, clone this repo
```
git clone https://github.com/omnimasudo/blossom-public/
```
...
To build your own Blossom, check out the [Build Guide](https://github.com/omnimasudo/blossom-public/wiki). The rest of this document will teach you how to set up the software to run the robot.
...
The app can be installed on [Android](https://play.google.com/store/apps/details?id=host.exp.exponent) via the Expo Client app. Then, find the last stable release by searching for `https://exp.host/@omnimasudo/blossom-app`.
